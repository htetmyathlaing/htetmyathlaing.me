...
export default function Contact() {
  return (
    <div>
      <h2 className="mb-4 text-2xl">Follow Me</h2>
      <div className="flex flex-wrap space-x-4">
        <Link
          href="mailto:contact@htetmyathlaing.me"
          className="mb-4"
          target="_blank"
        ...
        <Link
          href="https://www.linkedin.com/in/htetmyathlaing/"
          className="mb-4"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <Link
          href="https://facebook.com/htetmyathlaing"
          className="mb-4"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <Link
          href="https://twitter.com/htetmyathlaing"
          className="mb-4"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <Link
          href="https://instagram.com/hm.htetmyathlaing"
          className="mb-4"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <Link
          href="https://www.youtube.com/@htetmyathlaing-dev"
          className="mb-4"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <Link
          href="https://github.com/htetmyathlaing"
          className="mb-4"
          target="_blank"
          rel="noopener noreferrer"
        >
